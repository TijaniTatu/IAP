...
class DrugsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table("drugs")->insert([
            ['name' => 'Paracetamol', 'description' => 'Paracetamol is a painkiller used to relieve mild to moderate pain and fever. It is often recommended as one of the first treatments for pain, as it\'s safe for most people to take and side effects are rare.','quantity'=> 10, 'category_id' => 1],
            ['name' => 'Ibuprofen', 'description' => 'Ibuprofen is a painkiller available over the counter without a prescription. It\'s one of a group of painkillers called non-steroidal anti-inflammatory drugs (NSAIDs) and can be used to: ease mild to moderate pain – such as toothache, migraine and period pain','quantity'=> 10, 'category_id' => 2],
            ...
            ['name' => 'Morphine', 'description' => 'Morphine is a pain medication of the opiate family which is found naturally in a number of plants and animals. It acts directly on the central nervous system (CNS) to decrease the feeling of pain.', 'quantity'=> 10,'category_id' => 3],
            ...
            ['name' => 'Naproxen', 'description' => 'Naproxen is a medicine that reduces inflammation and pain in joints and muscles. It\'s used to treat diseases of joints, such as rheumatoid arthritis, osteoarthritis and gout. It\'s also used for period pain and muscle and bone disorders, such as back pain and sprains and strains.','quantity'=> 10, 'category_id' => 5]
